...
const Search = ({ query, setQuery, pos, setPos }) => {
  ...
  return (
    <>
      <div className="flex justify-center mt-8 text-stone-600 font-sans font-bold text-3xl md:text-5xl">
        ESAmazon Search
      </div>
      <div className="search mt-20  flex justify-center">
        <div className="mx-4 flex justify-start">
          ...
          <button
            type="submit"
            onClick={handleClick}
            className=" border w-12 rounded-r-lg px-4 shadow-lg shadow-slate-500  border-slate-700 bg-blue-200"
          >
            <BsSearch />
          </button>
        </div>
