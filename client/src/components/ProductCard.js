...
const ProductCard = ({ cardKey, name, image, price, stars, url, productId }) => {
    ...
    <div className=" shadow-lg shadow-slate-500 rounded-lg mb-40 sm:mb-20 mt-20 w-[300px] h-[420px] my-4 bg-gray-100 border border-stone-900">
      ...
      <div className="productButton flex justify-center mt-2 mb-4 mx-5  ">
        <button
          ...
          className="px-5 py-1 rounded-xl border-2  font-semibold  shadow-lg shadow-slate-500 border-slate-800 hover:bg-yellow-500 bg-yellow-400"
        >
          View
        </button>
      </div>
